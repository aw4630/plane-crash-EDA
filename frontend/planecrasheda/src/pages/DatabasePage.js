  ...
  return (
    ...
    <div style={{ padding: '0.5px' }}>
      ...
      <div style={{
        ...
        padding: '5px', // Adjust the padding for space
        marginBottom: '10px', // Space between the image and the table
        backgroundColor: 'rgba(255, 255, 255, 0.92)',  //adjust opactiy
        backgroundBlendMode: 'overlay' // Blend the image with the background color

        }}>
      <Link to="/" style={{ fontSize: '20px', fontWeight: 'bold', color: '#6f42c1' }}>
        Back to Home
      </Link>
